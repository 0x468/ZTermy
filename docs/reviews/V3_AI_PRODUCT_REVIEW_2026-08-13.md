...
| External Agent/SDK selector | In progress | `0.3.11`; Codex App Server protocol foundation is implemented, while client lifecycle, capability gating, terminal-tool bridging, recovery, and UI remain open; adapters stay separate from the built-in ztermy Agent |

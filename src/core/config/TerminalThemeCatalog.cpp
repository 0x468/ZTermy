...
constexpr std::array<BuiltInSpec, 10> builtInSpecs = {{
    {.id = "ztermy-dark",
     ...
     .accent = "",
     .ansi = {0x1E293B, 0xF87171, 0x4ADE80, 0xFBBF24, 0x60A5FA, 0xC084FC, 0x22D3EE, 0xCBD5E1, 0x475569, 0xFCA5A5,
              0x86EFAC, 0xFDE68A, 0x93C5FD, 0xD8B4FE, 0x67E8F9, 0xF8FAFC}},
    {.id = "ztermy-light",
     .name = "ztermy Light",
     .dark = false,
     .background = 0xFFFFFF,
     ...
     .cursor = 0x7C3AED,
     .selection = 0xBFDBFE,
     .selectionText = 0x0F172A,
     .accent = "",
     .ansi = {0x0F172A, 0xB91C1C, 0x15803D, 0xB45309, 0x1D4ED8, 0x7E22CE, 0x0E7490, 0x94A3B8, 0x475569, 0xDC2626,
              0x16A34A, 0xD97706, 0x2563EB, 0x9333EA, 0x0891B2, 0xE2E8F0}},
    {.id = "one-dark",
     .name = "One Dark",
     .dark = true,
     .background = 0x282C34,
     ...
     .selectionText = 0xFFFFFF,
     .accent = "#61AFEF",
     .ansi = {0x282C34, 0xE06C75, 0x98C379, 0xE5C07B, 0x61AFEF, 0xC678DD, 0x56B6C2, 0xABB2BF, 0x5C6370, 0xE06C75,
              0x98C379, 0xE5C07B, 0x61AFEF, 0xC678DD, 0x56B6C2, 0xFFFFFF}},
    {.id = "dracula",
     .name = "Dracula",
     .dark = true,
     .background = 0x282A36,
     ...
     .cursor = 0xF8F8F2,
     .selection = 0x44475A,
     .selectionText = 0xF8F8F2,
     .accent = "#BD93F9",
     .ansi = {0x21222C, 0xFF5555, 0x50FA7B, 0xF1FA8C, 0xBD93F9, 0xFF79C6, 0x8BE9FD, 0xF8F8F2, 0x6272A4, 0xFF6E6E,
    ...
    {.id = "solarized-dark",
     ...
     .accent = "#268BD2",
     .ansi = {0x073642, 0xDC322F, 0x859900, 0xB58900, 0x268BD2, 0xD33682, 0x2AA198, 0xEEE8D5, 0x002B36, 0xCB4B16,
    ...
    {.id = "gruvbox-dark",
     ...
     .accent = "#D79921",
     .ansi = {0x282828, 0xCC241D, 0x98971A, 0xD79921, 0x458588, 0xB16286, 0x689D6A, 0xA89984, 0x928374, 0xFB4934,
    ...
    {.id = "nord",
     ...
     .cursor = 0xD8DEE9,
     .selection = 0x434C5E,
     .selectionText = 0xECEFF4,
     .accent = "#88C0D0",
     .ansi = {0x3B4252, 0xBF616A, 0xA3BE8C, 0xEBCB8B, 0x81A1C1, 0xB48EAD, 0x88C0D0, 0xE5E9F0, 0x4C566A, 0xBF616A,
    ...
    {.id = "catppuccin-mocha",
     ...
     .cursor = 0xF5E0DC,
     .selection = 0x45475A,
     .selectionText = 0xCDD6F4,
     .accent = "#CBA6F7",
     .ansi = {0x45475A, 0xF38BA8, 0xA6E3A1, 0xF9E2AF, 0x89B4FA, 0xF5C2E7, 0x94E2D5, 0xBAC2DE, 0x585B70, 0xF38BA8,
              0xA6E3A1, 0xF9E2AF, 0x89B4FA, 0xF5C2E7, 0x94E2D5, 0xA6ADC8}},
    {.id = "tokyo-night",
     .name = "Tokyo Night",
     .dark = true,
     .background = 0x1A1B26,
     ...
     .accent = "#7AA2F7",
     .ansi = {0x15161E, 0xF7768E, 0x9ECE6A, 0xE0AF68, 0x7AA2F7, 0xBB9AF7, 0x7DCFFF, 0xA9B1D6, 0x414868, 0xF7768E,

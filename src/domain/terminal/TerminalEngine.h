...
enum class TerminalUnderlineStyle : std::uint8_t
{
    none,
    single,
    doubleLine,
...
struct TerminalCell
{
    ...
    std::optional<TerminalColor> underlineColor;
...
public:
    ...
    // Returns and clears terminal protocol responses generated by feed().
    [[nodiscard]] virtual std::vector<std::byte> takePtyWrite() = 0;

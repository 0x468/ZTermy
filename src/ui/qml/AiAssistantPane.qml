...
Rectangle {
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            border.width: 1
            Accessible.role: Accessible.Pane
            Accessible.name: pane.toolApproval.kind === "interrupt_command" ? qsTr("AI interrupt approval") : pane.toolApproval.kind === "write_to_pty" ? qsTr("AI terminal input approval") : qsTr("AI command approval")
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Text {
                        Layout.fillWidth: true
                        text: pane.toolApproval.highRisk ? qsTr("High-risk command requires approval") : pane.toolApproval.kind === "interrupt_command" ? qsTr("Terminal interrupt requires approval") : pane.toolApproval.kind === "write_to_pty" ? qsTr("Terminal input requires approval") : qsTr("Command requires approval")
                ...
                TextEdit {
                    ...
                    font.family: Theme.terminalFont
                    font.pixelSize: Theme.textBody
                    Accessible.name: pane.toolApproval.kind === "interrupt_command" ? qsTr("Interrupt awaiting approval") : pane.toolApproval.kind === "write_to_pty" ? qsTr("Terminal input awaiting approval") : qsTr("Command awaiting approval")
                ...
                RowLayout {
                    ...
                    ActionButton {
                        text: pane.toolApproval.kind === "interrupt_command" ? qsTr("Send Ctrl+C") : pane.toolApproval.kind === "write_to_pty" ? qsTr("Send input") : qsTr("Run command")
                        iconName: pane.toolApproval.kind === "interrupt_command" ? "close" : pane.toolApproval.kind === "write_to_pty" ? "composer" : "play"

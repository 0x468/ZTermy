...
Button {
    ...
    readonly property color restColor: primary
                                                ? Theme.accent
                                                : destructive
                                                  ? Theme.dangerSurface
                                                  : Theme.controlBackground
    readonly property color hoverColor: primary
                                                 ? Theme.accentHover
                                                 : destructive
                                                   ? Theme.dangerHover
                                                   : Theme.controlHover
    readonly property color pressedColor: primary
                                                   ? Theme.accentPressed
                                                   : destructive
                                                     ? Theme.dangerPressed
                                                     : Theme.controlPressed
    readonly property color foregroundColor: primary
                                                       ? Theme.accentText
                                                       : destructive

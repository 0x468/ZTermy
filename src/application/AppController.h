...
class AppController final : public QObject
{
    ...
    Q_PROPERTY(bool aiChatGptConfigured READ aiChatGptConfigured NOTIFY credentialVaultChanged)
...
public:
    ...
    [[nodiscard]] bool aiChatGptConfigured() const;
    ...
    Q_INVOKABLE QString extractTerminalPaneToTab(const QString &paneId);
...
private:
    ...
    [[nodiscard]] bool applyTerminalTransfer(const workbench::TerminalWorkspaceTransfer &transfer);
    ...
    QHash<QString, QPointer<QObject>> m_terminalInputBindings;

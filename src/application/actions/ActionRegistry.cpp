...
constexpr std::array actions{
    ...
    ActionDescriptor{
        .id = "tabs.duplicate",
        .category = "tabs",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Duplicate terminal tab"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Open a fresh session from the active terminal tab."),
        .defaultShortcut = "",
        .terminalRequired = true,
        .paletteVisible = true,
        .autoRepeat = false,
    ...
    ActionDescriptor{
        ...
        .category = "tabs",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Reopen closed terminal"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Open a fresh session from the last closed terminal."),
        .defaultShortcut = "",
        .terminalRequired = false,
        .paletteVisible = true,
        .autoRepeat = false,
    ...
    ActionDescriptor{
        ...
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Open a new local terminal beside the active pane."),
        .defaultShortcut = "Alt+Shift+H",
        .terminalRequired = true,
        .paletteVisible = true,
        .autoRepeat = false,
    },
    ActionDescriptor{
        ...
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Split pane vertically"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Open a new local terminal below the active pane."),
    ...
    ActionDescriptor{
        .id = "terminal.duplicatePane",
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Duplicate active pane"),
        .description = QT_TRANSLATE_NOOP(
            "ActionRegistry", "Open another local shell or reconnect the active saved SSH profile in a new pane."),
    ...
    ActionDescriptor{
        ...
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Focus next pane"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Move keyboard focus to the next terminal pane."),
    ...
    ActionDescriptor{
        ...
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Focus previous pane"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Move keyboard focus to the previous terminal pane."),
    ...
    ActionDescriptor{
        .id = "terminal.growPane",
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Grow active pane"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Increase the active pane's share of its parent split."),
        .defaultShortcut = "Alt+Shift+Right",
        .terminalRequired = true,
        .paletteVisible = true,
        .autoRepeat = true,
    },
    ActionDescriptor{
        .id = "terminal.shrinkPane",
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Shrink active pane"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Decrease the active pane's share of its parent split."),
        .defaultShortcut = "Alt+Shift+Left",
        .terminalRequired = true,
        .paletteVisible = true,
        .autoRepeat = true,
    },
    ActionDescriptor{
        .id = "terminal.swapNextPane",
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Swap with next pane"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Move the active terminal session to the next pane."),
        .defaultShortcut = "",
        .terminalRequired = true,
        .paletteVisible = true,
        .autoRepeat = false,
    ...
    ActionDescriptor{
        .id = "terminal.swapPreviousPane",
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Swap with previous pane"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Move the active terminal session to the previous pane."),
        .defaultShortcut = "",
        .terminalRequired = true,
        .paletteVisible = true,
        .autoRepeat = false,
    ...
    ActionDescriptor{
        ...
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Quick select terminal target"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry",
                                         "Label visible links, paths, addresses, and hashes for keyboard selection."),
    ...
    ActionDescriptor{
        .id = "terminal.copyMode",
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Enter terminal Copy Mode"),
        .description =
            QT_TRANSLATE_NOOP("ActionRegistry", "Navigate and extend a terminal selection entirely from the keyboard."),
    ...
    ActionDescriptor{
        ...
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Select all terminal output"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Select the complete terminal buffer and scrollback."),
        .defaultShortcut = "",
        .terminalRequired = true,
        .paletteVisible = true,
        .autoRepeat = false,
    ...
    ActionDescriptor{
        .id = "terminal.scrollLineUp",
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Scroll terminal up one line"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Move the local scrollback viewport up by one line."),
    ...
    ActionDescriptor{
        .id = "terminal.scrollLineDown",
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Scroll terminal down one line"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Move the local scrollback viewport down by one line."),
    ...
    ActionDescriptor{
        ...
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Scroll terminal up one page"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Move the local scrollback viewport up by one page."),
        .defaultShortcut = "Shift+PgUp",
        .terminalRequired = true,
        .paletteVisible = true,
        .autoRepeat = true,
    },
    ActionDescriptor{
        ...
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Scroll terminal down one page"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Move the local scrollback viewport down by one page."),
        .defaultShortcut = "Shift+PgDown",
        .terminalRequired = true,
        .paletteVisible = true,
        .autoRepeat = true,
    },
    ActionDescriptor{
        ...
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Scroll to terminal history start"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Move to the oldest retained terminal output."),
        .defaultShortcut = "Ctrl+Shift+Home",
        .terminalRequired = true,
        .paletteVisible = true,
        .autoRepeat = false,
    },
    ActionDescriptor{
        ...
        .category = "terminal",
        .label = QT_TRANSLATE_NOOP("ActionRegistry", "Scroll to live terminal output"),
        .description = QT_TRANSLATE_NOOP("ActionRegistry", "Return to the live terminal prompt."),
        .defaultShortcut = "Ctrl+Shift+End",
        .terminalRequired = true,
        .paletteVisible = true,
        .autoRepeat = false,
    },
